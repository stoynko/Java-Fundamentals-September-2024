...
public class E10_SoftUniExamResults {
    ...
    public static void main(String[] args) {
        ...
        "{username}-banned". In that case, you should remove the user from the contest but preserve his submissions in the total count of submissions for each language.
